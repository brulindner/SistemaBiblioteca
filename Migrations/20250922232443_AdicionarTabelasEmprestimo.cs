...
{
    /// <inheritdoc />
    public partial class AdicionarTabelasEmprestimo : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataDevolucaoRealizada = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Emprestimos_BIBLIOTECA_LivroId",
                        column: x => x.LivroId,
